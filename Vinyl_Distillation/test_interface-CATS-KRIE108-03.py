...
def main():
    ...
    heat_exchanger_cost = sim.get_heat_exchanger_cost('RADFRAC1')
    print(f"Current heat exchanger cost: {heat_exchanger_cost}")
    '''
    delta_T = sim.get_delta_T('RADFRAC1', 'REFRIG1')
    print(f"Current delta T: {delta_T}")
    
    acetylene_purity = sim.get_acetylene_purity("D1")
    print(f"Current acetylene purity: {acetylene_purity}")
    
    vc_purity = sim.get_vc_purity("D2")
    print(f"Current VC purity: {vc_purity}")
