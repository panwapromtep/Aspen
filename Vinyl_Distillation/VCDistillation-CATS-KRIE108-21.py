...
class VCDistillation(AspenSim):
    ...
    def unflatten_params(flat_array):
        x_dict = {
            "Radfrac": {"RADFRAC1": [flat_array[0]], "RADFRAC2": [flat_array[1]]},
        }
        return x_dict
    ...
    def calc_tac(self, results):
        ...
        column_1_heatex_capital = self.get_heat_exchanger_cost("RADFRAC1")
        column_2_heatex_capital = self.get_heat_exchanger_cost("RADFRAC2")
